  ...
  return (
    <PageShell>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold text-[var(--text-primary)]">Models</h1>
          <p className="mt-1 text-sm text-[var(--text-muted)]">Friendly aliases mapped to provider models and fallback routes.</p>
        </div>
